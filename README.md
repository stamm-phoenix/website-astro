...
> Before deploying to production, update the domain in `astro.config.mjs` (`site`) so canonical URLs, Open Graph tags, sitemap, and robots.txt point to the live hostname.
